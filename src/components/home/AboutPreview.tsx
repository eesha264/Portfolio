        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Eeshitha is a UI/UX designer based in California, dedicated to creating digital experiences that are both beautiful and functional. With a focus on user research and intuitive design, she helps brands connect with their audiences through thoughtful, accessible interfaces.
            </p>
